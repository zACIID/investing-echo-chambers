...
ggplot(communities.dt[size > 5,], aes(x=reorder(community, sentiment), y=size, fill=sentiment)) + 
...
```{r}
# TODO fix, copied from echo chambers example
...
ggplot(neighbors_data[!is.na(leaning) & !is.nan(nn_leaning)], 
       aes(x=leaning, y=nn_leaning)) +

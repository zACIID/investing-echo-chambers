...
#user.sentiment <- user.sentiment[user %in% spam.users, sentiment:=0]
```
...
```{r}
# TODO provare a mostrare solo community sopra il 95esimo percentile magari?
# perché plottare solo community non isolate mi sembra sbagliato 
# perché potrebbe eslcudere community isolate ma grandi

library(circlize)

png(filename="../visualizations/community-chord.png", width=3000, height=3000)
...
chordDiagram(
  ...
  grid.col=as.vector(chord_communities$color)
)
